# Feed Diário — IOCs Maliciosos 2026-07-14
...
On July 14, 2026, the automated CTI collection pipeline identified 305 indicators of compromise (IOCs) from public threat intelligence feeds, of which 204 were classified as malicious or suspicious after enrichment via VirusTotal and AbuseIPDB. The dataset includes 2 active C2 IP addresses identified via Feodo Tracker and 173 active phishing URLs from OpenPhish. Dominant phishing targets this cycle: Social Media (Meta) (31), Gaming (11). A defining characteristic is the abuse of legitimate hosting platforms — Blogspot (20), Vercel (16), GitHub Pages (15) — to evade domain reputation-based blocklists. Immediate blocking of all listed indicators at perimeter controls is recommended.
...
| **Target** | Multiple sectors — Social Media (Meta), Gaming, Streaming (Netflix) |
...
- **Credential Harvesting — Social Media:** 31 URLs impersonating Meta/Facebook/Instagram to steal login credentials
- **Credential Harvesting — E-commerce:** 5 URLs cloning Amazon checkout/login pages
- **Crypto Asset Theft:** 2 URLs impersonating Ledger, Trezor, MetaMask targeting wallet credentials and seed phrases
- **Gaming Platform Targeting:** 11 URLs impersonating Roblox, Fortnite, or PUBG to steal accounts and in-game assets
- **Banking & Delivery Impersonation:** 3 URLs targeting bank portals, payment services, and parcel delivery (DPD, USPS, T-Mobile)
- **Streaming Impersonation:** 5 Netflix clone pages designed to harvest payment credentials
- **Infrastructure Abuse:** Phishing pages hosted on legitimate PaaS platforms (Blogspot, Vercel, GitHub Pages) to evade reputation-based blocking
...
|----------|------|
| Others | 114 |
| Social Media (Meta) | 31 |
| Gaming | 11 |
| Streaming (Netflix) | 5 |
| E-commerce (Amazon) | 5 |
| Banking / Finance / Delivery | 3 |
| Crypto / Wallets | 2 |
| Microsoft | 2 |
...
| **Infrastructure** | C2: Multiple cloud providers (DigitalOcean AS14061, Amazon AWS AS14618). Phishing: Blogspot, Vercel, GitHub Pages used as disposable infrastructure — rotated to evade static blocklists. |
| **Victim** | End users globally across multiple sectors: social media (meta), gaming, streaming (netflix). Broad-spectrum targeting with no identified geographic restriction. |
...
|--------|-----------|----|-----------|
| Initial Access | Phishing: Spearphishing Link | T1566.002 | 173 active phishing URLs targeting social media (meta), gaming |
| Resource Development | Link Target | T1608.005 | Phishing infrastructure hosted on Blogspot (20), Vercel (16), GitHub Pages (15) to evade reputation blocks |
...
### Detection
- Flag outbound HTTP/HTTPS connections to Blogspot, Vercel, GitHub Pages subdomains for unusual patterns
