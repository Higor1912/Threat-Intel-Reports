# Feed Diário — IOCs Maliciosos 2026-06-30
...
On June 30, 2026, the automated CTI collection pipeline identified 305 indicators of compromise (IOCs) from public threat intelligence feeds, of which 305 were classified as malicious or suspicious after enrichment via VirusTotal and AbuseIPDB. The dataset includes 2 active C2 IP addresses identified via Feodo Tracker and 300 active phishing URLs from OpenPhish. Dominant phishing targets this cycle: Gaming (16), Social Media (Meta) (11). A defining characteristic is the abuse of legitimate hosting platforms — Blogspot (21), Vercel (17), GitHub Pages (15) — to evade domain reputation-based blocklists. Immediate blocking of all listed indicators at perimeter controls is recommended.
...
| **Target** | Multiple sectors — Gaming, Social Media (Meta), Crypto / Wallets |
...
- **Credential Harvesting — Social Media:** 11 URLs impersonating Meta/Facebook/Instagram to steal login credentials
- **Credential Harvesting — E-commerce:** 2 URLs cloning Amazon checkout/login pages
- **Crypto Asset Theft:** 8 URLs impersonating Ledger, Trezor, MetaMask targeting wallet credentials and seed phrases
- **Gaming Platform Targeting:** 16 URLs impersonating Roblox, Fortnite, or PUBG to steal accounts and in-game assets
- **Banking & Delivery Impersonation:** 6 URLs targeting bank portals, payment services, and parcel delivery (DPD, USPS, T-Mobile)
- **Streaming Impersonation:** 6 Netflix clone pages designed to harvest payment credentials
...
| **Victim** | End users globally across multiple sectors: gaming, social media (meta), crypto / wallets. Broad-spectrum targeting with no identified geographic restriction. |
...
|--------|-----------|----|-----------|
| Initial Access | Phishing: Spearphishing Link | T1566.002 | 300 active phishing URLs targeting gaming, social media (meta) |
| Resource Development | Link Target | T1608.005 | Phishing infrastructure hosted on Blogspot (21), Vercel (17), GitHub Pages (15) to evade reputation blocks |
